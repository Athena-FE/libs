 ...
 * @class storage 存储器
 */
var Storages = /** @class */ (function (_super) {
    __extends(Storages, _super);
    function Storages(prefixOfKey) {
     ...
     */
    Storages.prototype.getLtg = function (key) {
     ...
     * @param key
     */
    Storages.prototype.getStg = function (key) {
        return this.getStorage({
            key: key,
            isLocal: false
        });
     ...
     */
    Storages.prototype.setStorage = function (params) {
     ...
     */
    Storages.prototype.getStorage = function (params) {
     ...
     */
    Storages.prototype.delStorage = function (params) {
        var isLocal = params.isLocal, key = params.key;
        var sKey = this.prefix + key;
        if (isLocal) {
     ...
     */
    Storages.prototype.getStorageUsedSize = function () {
     ...
     */
    Storages.prototype.isOutPeriod = function (obj) {
        if (!obj.value) {
            return true;
        }
...
exports["default"] = new Storages('st');
